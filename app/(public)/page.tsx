    ...
    <section className="relative min-h-[90vh] flex flex-col items-center pt-40 pb-48 overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-4xl px-6 text-center">
        <h1 className="font-serif text-5xl md:text-7xl leading-tight text-[#4a3728] italic">
          Renew, Relax,
          <br />
          <span className="not-italic font-medium">Rejuvenate</span>
        </h1>
        <p className="mt-4 text-lg md:text-xl text-[#7a6a5e] font-light tracking-wide">
          Experience the Finest Wellness Sanctuaries
        </p>
      </div>
  ...
  const services = [
    {
      ...
      desc: "Discover holistic wellness through our expert spa massages and body treatments.",
      img: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=80&w=800",
    },
    {
      id: "hair-styling",
      title: "Hair & Styling",
      desc: "Transform your look with our professional hair care, styling, and organic treatments.",
      img: "https://images.unsplash.com/photo-1560869713-7d0a29430803?q=80&w=800",
    },
    {
      id: "beauty-facials",
      title: "Beauty & Facials",
      desc: "Deep cleansing and rejuvenating facials designed to bring out your natural glow.",
      img: "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=800",
    },
    {
      id: "couple-spa",
      title: "Couple Spa",
      desc: "Experience ultimate relaxation together with our curated romantic couples packages.",
      img: "/couple.jpg",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="relative -mt-6 z-10 mb-20 text-center">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-[#5c4a44]">
            Our <span className="italic">Signature</span> Services
          </h2>
        </div>
...
function HowItWorks() {
  const steps = [
    { Icon: Search, title: "Find Your Sanctuary", desc: "Search through our hand-picked collection of top-tier luxury spas and salons." },
    { Icon: Calendar, title: "Effortless Booking", desc: "Select your preferred expert and schedule your visit in seconds with instant confirmation." },
    { Icon: Sparkles, title: "Experience Bliss", desc: "Step into serenity and enjoy a curated wellness experience tailored just for you." },
  ];
    ...
    <section className="bg-[#fdfaf7] py-32 border-t border-[#a6865d]/10">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-20">
          <p className="text-[#a6865d] text-xs uppercase tracking-[0.4em] mb-4 font-bold">The Process</p>
          <h2 className="font-serif text-4xl md:text-5xl text-[#5c4a44]">How It Works</h2>
        </div>
...
function Testimonials() {
  ...
  return (
    <section className="bg-white py-32 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-20">
          <p className="text-[#a6865d] text-xs uppercase tracking-[0.4em] mb-4 font-bold">Kind Words</p>
          <h2 className="font-serif text-4xl md:text-5xl text-[#5c4a44]">Client Stories</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-16">
          {reviews.map((review) => (
  ...
  return (
    <section className="bg-[#FAF7F4] py-32 text-center">
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-serif text-[#4a3728] mb-6">Find Spas in Your City</h2>
        <p className="text-[#7a6a5e] mb-12 font-light italic text-lg">Join our newsletter for exclusive spa offers & wellness tips</p>
        {isSubscribed ? (
          <div className="max-w-md mx-auto p-6 bg-white border border-[#b3936a]/30 rounded-[2rem] shadow-xl animate-in fade-in zoom-in duration-700">
            <p className="text-[#b3936a] font-serif text-xl italic">Thank you! Welcome to a world of relaxation. ✨</p>
          </div>
        ) : (
