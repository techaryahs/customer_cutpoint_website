...
export default function SpaDetailPage() {
  ...
  if (error || !spa) return <div className="min-h-screen bg-[#FAF9F6] pt-32 text-center text-cocoa font-bold">{error || tDetail('error_generic')}</div>;
