          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-3 mb-2">
              ...
              <div className="text-left md:text-right flex items-center md:block gap-3">
                ...
                <div className={`text-[7px] font-black uppercase tracking-[0.1em] px-2 py-0.5 rounded-full inline-block ${booking.paymentStatus === 'paid' ? 'bg-green-50 text-green-600' : 'bg-amber-50 text-amber-600'}`}>
              ...
              <div className="space-y-1">
                 ...
                 <div className="flex items-center gap-2">
                   ...
                   <div className="leading-tight">
                     ...
                     <p className="text-[9px] text-taupe font-bold uppercase tracking-tighter">{booking.totalDuration}m</p>
                   </div>
                 </div>
              </div>
            </div>
