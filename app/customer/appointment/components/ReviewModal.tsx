        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-8 md:p-10 text-center">
              ...
              <h2 className="text-2xl font-serif font-bold text-cocoa mb-2">Rate Your Experience</h2>
              <p className="text-taupe text-xs font-medium opacity-60 mb-8">
                How was your session at <span className="text-cocoa font-bold">{booking.place.name}</span>?
              </p>
